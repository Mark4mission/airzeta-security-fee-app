...
import { 
  Shield, Home, Megaphone, DollarSign, Package, Settings as SettingsIcon, 
  LogOut, ChevronLeft, ChevronRight, Menu, X, Users
} from 'lucide-react';
...
const NAV_ITEMS = [
  ...
  { path: '/security-level', label: 'Aviation Security', icon: Package, roles: ['hq_admin', 'branch_user'] },
